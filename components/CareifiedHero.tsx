...
const cards: CardData[] = [
  ...
  },
  {
    ...
    number: '02',
    label: 'For Agencies',
    headline: ['Stop hiring blind.', 'Search verified. Hire confident.'],
    href: '/agency',
    stat: '75%',
    ...
    popup: {
      ...
      sub: "Every caregiver on Careified has a verified record — credentials, placement history, and peer ratings you can trust before the first interview.",
      follow: "Better hires. Lower turnover. Real accountability.",
      cta: "Start searching",
    },
  },
  {
    ...
    number: '03',
    label: 'For Families',
    headline: ['Your family deserves', 'more than a resume.'],
    href: '/families',
    stat: '15+',
    ...
    popup: {
      ...
      sub: "See verified credentials, real work history, and ratings from families like yours — so you know exactly who is walking through your door.",
