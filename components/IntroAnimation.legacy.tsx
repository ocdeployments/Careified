...
export default function IntroAnimation({ onComplete }: Props) {
  ...
  async function runSequence() {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // ACT 2 — Glow + Brand lockup → auto-transition to landing page
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // Entire intro fades out: duration 700ms ease-in
    if (containerRef.current) {
      await animate(containerRef.current, { opacity: [1, 0] }, { duration: 0.7, ease: 'easeIn' })
    }
